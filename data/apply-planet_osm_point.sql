...
CREATE INDEX planet_osm_point_min_zoom_pois_index ON planet_osm_point USING gist(way) WHERE mz_poi_min_zoom IS NOT NULL;
CREATE INDEX planet_osm_point_min_zoom_pois_6_index ON planet_osm_point USING gist(way) WHERE mz_poi_min_zoom <= 6;
CREATE INDEX planet_osm_point_min_zoom_pois_9_index ON planet_osm_point USING gist(way) WHERE mz_poi_min_zoom <= 9;
CREATE INDEX planet_osm_point_min_zoom_pois_12_index ON planet_osm_point USING gist(way) WHERE mz_poi_min_zoom <= 12;
CREATE INDEX planet_osm_point_min_zoom_pois_15_index ON planet_osm_point USING gist(way) WHERE mz_poi_min_zoom <= 15;

...
ALTER TABLE planet_osm_polygon ADD COLUMN mz_landuse_label_min_zoom REAL;

UPDATE planet_osm_polygon SET
    mz_is_landuse = TRUE,
    mz_landuse_label_min_zoom = mz_calculate_landuse_label_min_zoom("landuse", "leisure", "natural", "highway", "amenity", "aeroway", "tourism", "man_made", "power", "boundary", way_area)

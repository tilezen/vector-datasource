...
WHERE
  amenity IN ('bbq', 'bicycle_repair_station', 'boat_rental', 'boat_storage', 'dive_centre', 'life_ring', 'picnic_table', 'shower', 'waste_disposal', 'watering_place', 'water_point', 'ranger_station') OR

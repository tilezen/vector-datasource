...
CREATE INDEX planet_osm_line_waterway_geom_index ON planet_osm_line USING gist(way) WHERE tags ? 'waterway' AND tags->'waterway' IN ('canal', 'river', 'stream', 'dam', 'ditch', 'drain');
...
CREATE INDEX planet_osm_line_railway_platform_index ON planet_osm_line USING gist(way) WHERE tags ? 'railway' and tags->'railway'='platform';

...
with bbox as
    ...
    from (values
        ...
        (st_transform(st_geomfromtext('POLYGON ((-63.73 15.55,-63.737 15.79,-63.500 15.79,-63.500 15.55,-63.737 15.55)))', 4326), 3857)),
        ...
        (st_transform(st_geomfromtext('POLYGON ((47.01 -11.86,47.01 -11.2,47.66 -11.2,47.66 -11.86,47.016 -11.86)))', 4326), 3857)),
        ...
        (st_transform(st_geomfromtext('POLYGON ((54.26 -16.14,54.26 -15.6,54.78 -15.6,54.785 -16.14,54.262 -16.14)))', 4326), 3857)),
        ...
        (st_transform(st_geomfromtext('POLYGON ((113.20 9.39,113.20 11.95,116.28 11.95,116.28 9.39,113.20 9.398)))', 4326), 3857)),
        ...
        (st_transform(st_geomfromtext('POLYGON ((9.373 0.80,9.37 0.81,9.38 0.81,9.38 0.80,9.37 0.80)))', 4326), 3857)),
        (st_transform(st_geomfromtext('POLYGON ((171.08 -22.78,171.08 -22.05,172.36 -22.05,172.36 -22.78,171.08 -22.78)))', 4326), 3857)),
        (st_transform(st_geomfromtext('POLYGON ((42.433 -17.31,42.433 -16.79,43.034 -16.79,43.034 -17.31,42.433 -17.31)))', 4326), 3857)),
        (st_transform(st_geomfromtext('POLYGON ((-66.503 80.81,-66.503 80.8,-66.396 80.8,-66.396 80.81,-66.503 80.81)))', 4326), 3857)),

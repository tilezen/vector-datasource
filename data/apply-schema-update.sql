...
PERFORM add_column_if_not_exists('ne_10m_admin_0_boundary_lines_disputed_areas_chn', 'mz_boundary_min_zoom', 'REAL');
...
PERFORM add_column_if_not_exists('ne_10m_roads', 'mz_road_min_zoom', 'REAL');

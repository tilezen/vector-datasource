...
We offer several free world basemap styles for Tangram, including [Refill, Cinnabar, and Zinc](https://mapzen.com/blog/introducing-refill-cinnabar-and-zinc-styles-for-tangram) and include varients with more or less labels. Pleaes remix them to suite your own designs!

...
assert_has_feature(
    ...
    {"kind": "highway", "highway": "motorway", "is_bridge": True,
     "id": 8918870, "sort_key": 447})
...
assert_has_feature(
    ...
    {"kind": "highway", "highway": "motorway", "is_bridge": True,
     "id": 27614705, "sort_key": 446})

# layer 3
#https://www.openstreetmap.org/way/29394019
assert_has_feature(
    18, 41916, 101364, "roads",
    {"kind": "highway", "highway": "motorway_link", "is_bridge": True,
     "id": 29394019, "sort_key": 445})
...
assert_has_feature(
    ...
    {"kind": "highway", "highway": "motorway", "is_bridge": True,
     "id": 28412298, "sort_key": 443})

# layer -1
#https://www.openstreetmap.org/way/43685501
assert_has_feature(
    18, 41888, 101294, "roads",
    {"kind": "minor_road", "highway": "service", "is_tunnel": True,
     "id": 43685501, "sort_key": 304})

# layer -2
#https://www.openstreetmap.org/way/50691047
assert_has_feature(
    18, 41967, 101293, "roads",
    {"kind": "highway", "highway": "motorway", "is_tunnel": True,
     "id": 50691047, "sort_key": 303})

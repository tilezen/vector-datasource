...
class RoadSortKeysAeroway(FixtureTest):
    def test_runway(self):
        self.generate_fixtures(dsl.way(214484985, wkt_loads('LINESTRING (-75.86166034196658 41.136580722233, -75.86071738041289 41.13658227832178, -75.85680737330719 41.13660839354539)'), {u'source': u'openstreetmap.org', u'aeroway': u'runway', u'surface': u'grass'}))

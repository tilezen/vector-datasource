...
class MoveBarriersToLanduse(FixtureTest):
    ...
    def test_citywalls(self):
        ...
        self.generate_fixtures(dsl.way(392978585, wkt_loads('LINESTRING (24.4720476224511 35.37148697890318, 24.4712704898988 35.3713100065569)'), {u'source': u'openstreetmap.org', u'historic': u'citywalls'}))
    ...
    def test_retaining_wall(self):
        ...
        self.generate_fixtures(dsl.way(288896098, wkt_loads('LINESTRING (-73.99848590124648 40.75414757104189, -73.99858175148739 40.75397751643467, -73.9986491251337 40.75378119434839, -73.99868658488099 40.75361998524168)'), {u'source': u'openstreetmap.org', u'barrier': u'retaining_wall'}))
    ...
    def test_snow_fence(self):
        ...
        self.generate_fixtures(dsl.way(356771680, wkt_loads('LINESTRING (-105.418546531019 41.17472586849339, -105.417813236252 41.17203419617208, -105.417465408574 41.17044640452401)'), {u'source': u'openstreetmap.org', u'man_made': u'snow_fence'}))

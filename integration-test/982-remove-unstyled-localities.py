...
class RemoveUnstyledLocalities(FixtureTest):
    def test_zoom_8(self):
        ...
        # population.
        self.load_fixtures(['https://www.openstreetmap.org/node/141029389'])
    ...
    def test_zoom_9_10(self):
        ...
        self.load_fixtures(['http://www.openstreetmap.org/node/4270230299'])
    ...
    def test_zoom_11(self):
        ...
        self.load_fixtures(['http://www.openstreetmap.org/node/150949805'])
    ...
    def test_zoom_12(self):
        ...
        self.load_fixtures(['http://www.openstreetmap.org/node/150966610'])
    ...
    def test_zoom_13_and_up(self):
        ...
        self.load_fixtures(['http://www.openstreetmap.org/node/150973394'])

...
class RemoveUnstyledLocalities(FixtureTest):
    def test_zoom_8(self):
        ...
        # population.
        self.generate_fixtures(dsl.way(141029389, wkt_loads('POINT (-124.082839865403 40.86651697352439)'), {u'gnis:ST_alpha': u'CA', u'gnis:County_num': u'023', u'name': u'Arcata', u'census:population': u'17231;2010', u'gnis:ST_num': u'06', u'wikipedia': u'en:Arcata, California', u'gnis:County': u'Humboldt', u'ele': u'7', u'source': u'openstreetmap.org', u'gnis:Class': u'Populated Place', u'place': u'town', u'population': u'17231', u'name:ru': u'\u0410\u0440\u043a\u0435\u0439\u0442\u0430', u'wikidata': u'Q631752', u'gnis:id': u'277471', u'import_uuid': u'bb7269ee-502a-5391-8056-e3ce0e66489c', u'is_in': u'Humboldt,California,Calif.,CA,USA'}))
    ...
    def test_zoom_9_10(self):
        ...
        self.generate_fixtures(dsl.way(4270230299, wkt_loads('POINT (-123.685686862951 41.0640389635313)'), {u'wikidata': u'Q5898327', u'place': u'town', u'name': u'Hoopa', u'source': u'openstreetmap.org'}))
    ...
    def test_zoom_11(self):
        ...
        self.generate_fixtures(dsl.way(150949805, wkt_loads('POINT (-122.587967324987 37.98729345716131)'), {u'gnis:ST_alpha': u'CA', u'gnis:County_num': u'041', u'name': u'Fairfax', u'census:population': u'7120;2006', u'gnis:ST_num': u'06', u'import_uuid': u'bb7269ee-502a-5391-8056-e3ce0e66489c', u'ele': u'35', u'source': u'openstreetmap.org', u'gnis:Class': u'Populated Place', u'place': u'village', u'population': u'7120', u'gnis:County': u'Marin', u'gnis:id': u'277511', u'is_in': u'Marin,California,Calif.,CA,USA'}))

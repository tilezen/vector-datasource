...
class RemovePropsRoadMerge(FixtureTest):
    ...
    def test_drop_oneway_but_not_bridge(self):
        ...
        self.generate_fixtures(dsl.way(302933871, wkt_loads('LINESTRING (-81.2011780289799 36.92756280303799, -81.2006921302427 36.92767030393928)'), {u'bridge': u'yes', u'horse': u'no', u'maxspeed': u'70 mph', u'lanes': u'2', u'tiger:cfcc': u'A15', u'source': u'openstreetmap.org', u'hgv': u'designated',
                               u'tiger:reviewed': u'no', u'layer': u'1', u'tiger:name_base_1': u'United States Highway 52', u'tiger:name_base': u'I-81', u'oneway': u'yes', u'foot': u'no', u'bicycle': u'no', u'sidewalk': u'none', u'ref': u'I 81', u'tiger:county': u'Wythe, VA', u'highway': u'motorway'}))
    ...
    def test_drop_crossing(self):
        self.generate_fixtures(dsl.way(4324682054, wkt_loads('POINT (-71.5924171338517 42.24481519215379)'), {u'crossing': u'uncontrolled', u'source': u'openstreetmap.org'}), dsl.way(434308106, wkt_loads(
            'LINESTRING (-71.5923849741645 42.24490051209801, -71.5924171338517 42.24481519215379, -71.5924668106869 42.24471191696178)'), {u'crossing': u'zebra', u'source': u'openstreetmap.org', u'surface': u'concrete', u'highway': u'pedestrian'}))

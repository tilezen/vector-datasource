...
class Waterfall(FixtureTest):
    ...
    def test_more_than_50m(self):
        ...
        self.generate_fixtures(dsl.way(2384221575, wkt_loads('POINT (-119.597269131638 37.7542908234491)'), {u'gnis:state_id': u'06', u'name': u'Middle Cascades', u'wikipedia:en': u'Yosemite_Falls', u'wikipedia': u'en:Yosemite Falls', u'gnis:county_id': u'043', u'height': u'206', u'source': u'openstreetmap.org', u'wikidata': u'Q491677', u'alt_name': u'Yosemite Falls', u'waterway': u'waterfall', u'name:zh': u'\u4e2d\u4f18\u80dc\u7f8e\u5730\u5927\u7011\u5e03', u'gnis:feature_id': u'252230'}))
    ...
    def test_height_missing(self):
        ...
        self.generate_fixtures(dsl.way(2375445789, wkt_loads('POINT (-122.783122278043 37.95391767741348)'), {u'wikipedia': u'en:Alamere Falls', u'waterway': u'waterfall', u'wikidata': u'Q37957', u'name': u'Alamere Falls', u'source': u'openstreetmap.org'}))
        ...
        self.generate_fixtures(dsl.way(1247873121, wkt_loads('POINT (-119.631362801784 37.55080207032658)'), {u'source': u'openstreetmap.org', u'natural': u'waterfall', u'name': u'Lower Chilnualna Fall'}))
        ...
        self.generate_fixtures(dsl.way(1247872815, wkt_loads('POINT (-119.612561242551 37.56504890695991)'), {u'note': u'Series of cascades on Chilnualna Creek. Not technically part of Chilnualna Falls, but part of the same system', u'source': u'openstreetmap.org', u'natural': u'waterfall', u'name': u'Chilnualna Creek Cascades'}))
    ...
    def test_less_than_8m(self):
        ...
        self.generate_fixtures(dsl.way(3257658773, wkt_loads('POINT (-122.153388082347 37.94552742279537)'), {u'source': u'openstreetmap.org', u'waterway': u'waterfall', u'name': u'Abrigo Falls', u'height': u'4.5'}))
    ...
    def test_unit_conversion_height(self):
        ...
        self.generate_fixtures(dsl.way(877270365, wkt_loads('POINT (-82.96562582334471 35.09064146759331)'), {u'source': u'openstreetmap.org', u'waterway': u'waterfall', u'name': u'Rainbow Falls', u'height': u'150 ft'}))
        ...
        self.generate_fixtures(dsl.way(404574988, wkt_loads('POINT (-83.3606066994399 34.59619179112848)'), {u'source': u'openstreetmap.org', u'waterway': u'waterfall', u'natural': u'cliff', u'name': u'Toccoa Falls', u'height': u"186'"}))
        ...
        self.generate_fixtures(dsl.way(3647404249, wkt_loads('POINT (-78.7516626920262 42.70175278571357)'), {u'natural': u'cliff', u'name': u'Eternal Flame Falls', u'height': u'9 m', u'source': u'openstreetmap.org', u'waterway': u'waterfall', u'tourism': u'attraction'}))

...
class RoadSortKeysLayers(FixtureTest):
    ...
    def test_layer_4(self):
        # layer 4
        self.generate_fixtures(dsl.way(8918870, wkt_loads('LINESTRING (-122.411178697409 37.73354279788042, -122.409649944459 37.73416535950228, -122.409213363231 37.7343443902903, -122.408764115757 37.7345183054984, -122.408334990546 37.73467950350251, -122.407874963289 37.73483437829259, -122.405695740241 37.735536496959)'), {u'bridge': u'yes', u'horse': u'no', u'tiger:name_base': u'I-280', u'lanes': u'2', u'name': u'Southern Embarcadero Freeway', u'tiger:cfcc': u'A15', u'hgv': u'designated', u'layer': u'4', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'oneway': u'yes', u'foot': u'no', u'bicycle': u'no', u'sidewalk': u'none', u'ref': u'I 280', u'highway': u'motorway'}))
    ...
    def test_layer_2(self):
        # layer 2
        self.generate_fixtures(dsl.way(27651523, wkt_loads('LINESTRING (-122.431455290339 37.6276109841108, -122.431086172589 37.6272982960442, -122.430708610675 37.62696518753708)'), {u'bridge': u'yes', u'horse': u'no', u'maxspeed': u'65 mph', u'lanes': u'4', u'name': u'Junipero Serra Freeway', u'hgv': u'designated', u'layer': u'2', u'maxspeed:trailer': u'55 mph', u'source': u'openstreetmap.org', u'maxspeed:hgv': u'55 mph', u'oneway': u'yes', u'foot': u'no', u'bicycle': u'no', u'sidewalk': u'none', u'ref': u'I 280', u'highway': u'motorway'}))
    ...
    def test_layer_minus_2(self):
        # layer -2
        self.generate_fixtures(dsl.way(50691047, wkt_loads('LINESTRING (-122.36675233537 37.80855546520939, -122.365044188857 37.81017851999598)'), {u'tiger:name_base': u'I-80', u'layer': u'-2', u'maxspeed': u'50 mph', u'lanes': u'5', u'name': u'San Francisco \u2013 Oakland Bay Bridge', u'tiger:cfcc': u'A11', u'tiger:name_base_1': u'Bay', u'tunnel': u'yes', u'tiger:name_type_1': u'Brg', u'maxheight': u'14\'0"', u'source': u'openstreetmap.org', u'hgv': u'designated', u'oneway': u'yes', u'bicycle': u'no', u'ref': u'I 80', u'tiger:county': u'San Francisco, CA', u'highway': u'motorway'}))

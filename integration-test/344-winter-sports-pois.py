...
class WinterSportsPois(FixtureTest):
    ...
    def test_ski_shop(self):
        ...
        self.generate_fixtures(dsl.way(2720341705, wkt_loads('POINT (-116.889174638465 34.243057498121)'), {u'shop': u'ski', u'source': u'openstreetmap.org', u'name': u'Blauer Board Shop'}))

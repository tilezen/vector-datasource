...
class RangerStation(FixtureTest):
    def test_ranger_station_supersedes_tourism(self):
        ...
        # set
        self.generate_fixtures(dsl.way(1996636138, wkt_loads('POINT (-122.22175526536 37.17244957017029)'), {u'information': u'office', u'amenity': u'ranger_station', u'name': u'Big Basin Redwoods State Park Headquarters', u'wheelchair': u'yes', u'source': u'openstreetmap.org', u'tourism': u'information'}))
        ...
        # Node with amenity=ranger_station, but also has tourism=information
        # set
        self.generate_fixtures(dsl.way(351892607, wkt_loads('POINT (-122.603770307802 37.90397806289519)'), {u'source': u'openstreetmap.org', u'amenity': u'ranger_station', u'tourism': u'information', u'name': u'Pantoll Ranger Station'}))

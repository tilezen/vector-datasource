...
class NormalizeOperatorValues(FixtureTest):
    def test_us_national_park_service(self):
        ...
        self.generate_fixtures(dsl.way(4285104560, wkt_loads('POINT (-93.15995443474161 36.06406411633689)'), {u'operator': u'US National Park Service', u'capacity': u'31', u'tourism': u'camp_site', u'name': u'Ozark Campground', u'source': u'openstreetmap.org'}))
    ...
    def test_us_national_forest_service(self):
        ...
        self.generate_fixtures(dsl.way(796692690, wkt_loads('POINT (-122.08805873213 46.165678293632)'), {u'operator': u'US National Forest Service', u'toilets': u'outhouse', u'amenity': u'toilets', u'source': u'openstreetmap.org'}))
    ...
    def test_nsw_parks_and_wildlife_service(self):
        ...
        self.generate_fixtures(dsl.way(2514034066, wkt_loads('POINT (148.493255333852 -35.87963414153472)'), {u'website': u'http://www.nationalparks.nsw.gov.au/kosciuszko-national-park/wolgal-hut/accommodation', u'amenity': u'shelter', u'name': u'Wolgal Lodge', u'source': u'openstreetmap.org', u'wheelchair': u'no', u'shelter_type': u'basic_hut', u'internet_access:fee': u'no', u'operator': u'NSW Parks and Wildlife Service', u'smoking': u'no', u'tourism': u'wilderness_hut', u'internet_access': u'no'}))

...
class BarrierTollBooth(FixtureTest):
    ...
    def test_02(self):
        ...
        self.generate_fixtures(dsl.way(392430963, wkt_loads('POINT (-122.46950532066 37.7701796937487)'), {u'source': u'openstreetmap.org', u'name': u'Main Gate', u'barrier': u'toll_booth'}))

...
class RoadsAccess(FixtureTest):
    ...
    def test_access_yes(self):
        ...
        self.generate_fixtures(dsl.way(1988099751, wkt_loads('POINT (18.6106772968205 54.32720157959729)'), {u'source': u'openstreetmap.org', u'bicycle': u'yes', u'highway': u'crossing'}),dsl.way(1988099752, wkt_loads('POINT (18.6106279793114 54.3272640757605)'), {u'source': u'openstreetmap.org', u'bicycle': u'yes', u'highway': u'crossing'}),dsl.way(151351130, wkt_loads('LINESTRING (18.6107030784692 54.3271706719878, 18.6106772968205 54.32720157959729, 18.6106279793114 54.3272640757605, 18.6105730024161 54.32730430794268)'), {u'bicycle': u'yes', u'segregated': u'yes', u'surface': u'paving_stones', u'access': u'yes', u'source': u'openstreetmap.org', u'foot': u'yes', u'highway': u'cycleway'}))

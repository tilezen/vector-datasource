...
class RoadSortKeysTunnel(FixtureTest):
    ...
    def test_trunk_level_0(self):
        self.generate_fixtures(dsl.way(259492789, wkt_loads('LINESTRING (-74.16702601822249 40.73275266220829, -74.16711180733211 40.73254919807029)'), {u'tunnel': u'yes', u'tiger:name_base': u'McCarter', u'hgv:state_network': u'yes', u'name': u'McCarter Highway', u'tiger:cfcc': u'A35', u'tiger:name_base_1': u'State Route 21', u'hgv': u'designated', u'tiger:zip_left': u'07104', u'tiger:zip_right': u'07104', u'lanes': u'4', u'source': u'openstreetmap.org', u'tiger:county': u'Essex, NJ', u'tiger:name_type': u'Hwy', u'NHS': u'yes', u'ref': u'NJ 21', u'NJDOT_SRI': u'00000021', u'HFCS': u'Urban Principal Arterial', u'source:hgv:state_network': u'NJDOT http://www.state.nj.us/transportation/about/rules/pdf/chapter32truckaccess.pdf', u'highway': u'trunk'}))
    ...
    def test_primary_level_0(self):
        self.generate_fixtures(dsl.way(117837633, wkt_loads('LINESTRING (-87.66710367120798 41.56470766559397, -87.66648446248269 41.56452229306039)'), {u'tiger:name_base': u'Dixie', u'name': u'Dixie Highway', u'tiger:cfcc': u'A41', u'tunnel': u'yes', u'tiger:reviewed': u'no', u'source': u'openstreetmap.org', u'tiger:county': u'Cook, IL', u'tiger:name_type': u'Hwy', u'highway': u'primary'}))
    ...
    def test_secondary_level_0(self):
        self.generate_fixtures(dsl.way(57782075, wkt_loads('LINESTRING (-87.64371486497609 41.7396067862949, -87.64368198663669 41.73869201695129)'), {u'tiger:source': u'tiger_import_dch_v0.6_20070809', u'tiger:name_base': u'Halsted', u'name': u'South Halsted Street', u'tiger:cfcc': u'A41', u'tiger:separated': u'no', u'tunnel': u'yes', u'tiger:zip_left': u'60628', u'tiger:zip_right': u'60628', u'source': u'openstreetmap.org', u'tiger:county': u'Cook, IL', u'tiger:tlid': u'111832601:111832606:111832754', u'tiger:name_direction_prefix': u'S', u'tiger:name_type': u'St', u'highway': u'secondary', u'tiger:upload_uuid': u'bulk_upload.pl-ee310570-36cc-43bc-bc7b-aff94618acaf'}))
    ...
    def test_service_level_0(self):
        self.generate_fixtures(dsl.way(190835369, wkt_loads('LINESTRING (-87.6339403862011 41.85666306423929, -87.6338758871637 41.85658478182989)'), {u'tunnel': u'yes', u'source': u'openstreetmap.org', u'name': u'South Wong Parkway', u'highway': u'service'}))

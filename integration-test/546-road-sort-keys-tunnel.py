...
class RoadSortKeysTunnel(FixtureTest):
    def test_motorway_level_0(self):
        ...
        self.generate_fixtures(dsl.way(3685132833, wkt_loads('POINT (-122.455329276656 37.80300739883197)'), {u'source': u'openstreetmap.org', u'ref': u'437', u'highway': u'motorway_junction'}), dsl.way(167952621, wkt_loads('LINESTRING (-122.455329276656 37.80300739883197, -122.454934107763 37.80304260388298, -122.45454783219 37.80306545876599, -122.454197309567 37.803080789988)'), {
                               u'lanes': u'3', u'name': u'Presidio Parkway', u'tunnel': u'yes', u'destination:street': u'Marina Boulevard', u'source': u'openstreetmap.org', u'alt_name': u'Doyle Drive', u'oneway': u'yes', u'ref': u'US 101', u'highway': u'motorway'}))
    ...
    def test_trunk_level_0(self):
        self.generate_fixtures(dsl.way(259492789, wkt_loads('LINESTRING (-74.16702601822249 40.73275266220829, -74.16711180733211 40.73254919807029)'), {u'tunnel': u'yes', u'tiger:name_base': u'McCarter', u'hgv:state_network': u'yes', u'name': u'McCarter Highway', u'tiger:cfcc': u'A35', u'tiger:name_base_1': u'State Route 21', u'hgv': u'designated', u'tiger:zip_left': u'07104',
                               u'tiger:zip_right': u'07104', u'lanes': u'4', u'source': u'openstreetmap.org', u'tiger:county': u'Essex, NJ', u'tiger:name_type': u'Hwy', u'NHS': u'yes', u'ref': u'NJ 21', u'NJDOT_SRI': u'00000021', u'HFCS': u'Urban Principal Arterial', u'source:hgv:state_network': u'NJDOT http://www.state.nj.us/transportation/about/rules/pdf/chapter32truckaccess.pdf', u'highway': u'trunk'}))
    ...
    def test_primary_level_0(self):
        self.generate_fixtures(dsl.way(117837633, wkt_loads('LINESTRING (-87.66710367120798 41.56470766559397, -87.66648446248269 41.56452229306039)'), {
                               u'tiger:name_base': u'Dixie', u'name': u'Dixie Highway', u'tiger:cfcc': u'A41', u'tunnel': u'yes', u'tiger:reviewed': u'no', u'source': u'openstreetmap.org', u'tiger:county': u'Cook, IL', u'tiger:name_type': u'Hwy', u'highway': u'primary'}))
    ...
    def test_secondary_level_0(self):
        self.generate_fixtures(dsl.way(57782075, wkt_loads('LINESTRING (-87.64371486497609 41.7396067862949, -87.64368198663669 41.73869201695129)'), {u'tiger:source': u'tiger_import_dch_v0.6_20070809', u'tiger:name_base': u'Halsted', u'name': u'South Halsted Street', u'tiger:cfcc': u'A41', u'tiger:separated': u'no', u'tunnel': u'yes',
                               u'tiger:zip_left': u'60628', u'tiger:zip_right': u'60628', u'source': u'openstreetmap.org', u'tiger:county': u'Cook, IL', u'tiger:tlid': u'111832601:111832606:111832754', u'tiger:name_direction_prefix': u'S', u'tiger:name_type': u'St', u'highway': u'secondary', u'tiger:upload_uuid': u'bulk_upload.pl-ee310570-36cc-43bc-bc7b-aff94618acaf'}))
    ...
    def test_residential_level_0(self):
        self.generate_fixtures(dsl.way(56393654, wkt_loads('LINESTRING (-87.6687173149529 41.85966997294218, -87.66872872355698 41.86017336309299)'), {u'tiger:source': u'tiger_import_dch_v0.6_20070809', u'tiger:name_base': u'Paulina', u'bicycle': u'yes', u'name': u'South Paulina Street', u'tiger:cfcc': u'A41', u'tiger:separated': u'no', u'tunnel': u'yes', u'tiger:zip_left': u'60608', u'tiger:zip_right': u'60608', u'tiger:reviewed': u'no',
                               u'source': u'openstreetmap.org', u'tiger:county': u'Cook, IL', u'tiger:tlid': u'111803173:111803174:111888591:111803151:111802722:111802724:111802727:111802728:111802730:111802740:111802742:111802744:111803143:111803146:111803147:111803148:111803152:111803155', u'tiger:name_direction_prefix': u'S', u'tiger:name_type': u'St', u'highway': u'residential', u'tiger:upload_uuid': u'bulk_upload.pl-ee310570-36cc-43bc-bc7b-aff94618acaf'}))
    ...
    def test_service_level_0(self):
        self.generate_fixtures(dsl.way(190835369, wkt_loads('LINESTRING (-87.6339403862011 41.85666306423929, -87.6338758871637 41.85658478182989)'), {
                               u'tunnel': u'yes', u'source': u'openstreetmap.org', u'name': u'South Wong Parkway', u'highway': u'service'}))

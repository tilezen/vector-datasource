...
class OutdoorShops(FixtureTest):
    def test_fishing(self):
        self.generate_fixtures(dsl.way(3056897308, wkt_loads('POINT (-118.965276301823 37.64610896194417)'), {u'shop': u'fishing', u'source': u'openstreetmap.org', u'name': u'The Trout Fitter'}))
    ...
    def test_hunting(self):
        ...
        self.generate_fixtures(dsl.way(1467729495, wkt_loads('POINT (-124.156607540242 40.80332877487159)'), {u'shop': u'hunting', u'addr:housenumber': u'1327', u'addr:city': u'Eureka', u'addr:postcode': u'95501', u'name': u'Old West Shootery & Supply', u'source': u'openstreetmap.org', u'addr:country': u'US', u'addr:street': u'5th Street'}))
    ...
    def test_outdoor(self):
        self.generate_fixtures(dsl.way(766201791, wkt_loads('POINT (-124.084844635623 40.86953316699248)'), {u'shop': u'outdoor', u'addr:housenumber': u'650', u'name': u"Adventure's Edge", u'opening_hours': u'Mo-Sa 09:00-18:00; Su 10:00-17:00', u'source': u'openstreetmap.org', u'addr:street': u'10th Street'}))
    ...
    def test_scuba_diving(self):
        self.generate_fixtures(dsl.way(3931687122, wkt_loads('POINT (-122.498863431955 37.86810888775278)'), {u'shop': u'scuba_diving', u'addr:housenumber': u'200', u'addr:city': u'Sausalito', u'addr:postcode': u'94965', u'addr:state': u'CA', u'name': u'Harbor Dive Center', u'source': u'openstreetmap.org', u'addr:street': u'Harbor Drive'}))
    ...
    def test_gas_canister(self):
        self.generate_fixtures(dsl.way(2135237099, wkt_loads('POINT (-121.999360877607 37.28441996256068)'), {u'shop': u'gas', u'source': u'openstreetmap.org', u'name': u'Valero'}))
    ...
    def test_motorcycle(self):
        self.generate_fixtures(dsl.way(3799971066, wkt_loads('POINT (-122.412868069132 37.77455850560839)'), {u'shop': u'motorcycle', u'addr:housenumber': u'220', u'addr:city': u'San Francisco', u'addr:postcode': u'94103', u'addr:state': u'CA', u'name': u'Desmoto Sport', u'source': u'openstreetmap.org', u'addr:street': u'9th Street'}))

...
class Lighthouse(FixtureTest):
    ...
    def test_without_attraction(self):
        ...
        self.generate_fixtures(dsl.way(1243877573, wkt_loads('POINT (-122.478338095523 37.8254848209094)'), {u'source': u'openstreetmap.org', u'man_made': u'lighthouse', u'name': u'Lime Point'}))

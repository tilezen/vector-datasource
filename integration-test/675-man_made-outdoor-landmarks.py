...
class ManMadeOutdoorLandmarks(FixtureTest):
    def test_communications_tower(self):
        self.generate_fixtures(dsl.way(1230069003, wkt_loads('POINT (-121.92892226938 37.8670382002752)'), {u'source': u'openstreetmap.org', u'man_made': u'communications_tower'}))
    ...
    def test_observatory(self):
        ...
        self.generate_fixtures(dsl.way(747693102, wkt_loads('POINT (-75.58143133824321 39.27851040008478)'), {u'website': u'www.DASEF.org', u'amenity': u'university', u'man_made': u'observatory', u'observatory:type': u'astronomical', u'source': u'openstreetmap.org', u'addr:street': u'ITEC Loop'}))
    ...
    def test_offshore_platform_node(self):
        self.generate_fixtures(dsl.way(2622856034, wkt_loads('POINT (-118.044507537345 33.6623171776256)'), {u'man_made': u'offshore_platform', u'type': u'oil', u'name': u'Platform Emmy', u'source': u'openstreetmap.org'}))
    ...
    def test_water_tower(self):
        self.generate_fixtures(dsl.way(1501843094, wkt_loads('POINT (-122.428099094606 37.70762977463859)'), {u'source': u'openstreetmap.org', u'man_made': u'water_tower'}))
    ...
    def test_mast(self):
        ...
        self.generate_fixtures(dsl.way(3679715072, wkt_loads('POINT (-121.833830835485 37.2910862055756)'), {u'source': u'openstreetmap.org', u'man_made': u'mast'}))

...
class CyclewayEqualsNo(FixtureTest):
    def test_centre(self):
        ...
        self.generate_fixtures(dsl.way(65328690, wkt_loads('POINT (-122.405056678748 37.78776849537549)'), {u'source': u'openstreetmap.org', u'turn_restrictions': u'no', u'highway': u'traffic_signals'}),dsl.way(184956229, wkt_loads('LINESTRING (-122.405056678748 37.78776849537549, -122.405140671227 37.7881806771727)'), {u'bicycle': u'yes', u'lanes': u'2', u'name': u'Grant Avenue', u'tiger:cfcc': u'A41', u'surface': u'paved', u'cycleway': u'no', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'tiger:name_type': u'Ave', u'oneway': u'no', u'turn:lanes:backward': u'right', u'lanes:backward': u'1', u'sidewalk': u'both', u'lanes:forward': u'1', u'highway': u'secondary'}))

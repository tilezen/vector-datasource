...
class RemoveOsmNeighbourhoods(FixtureTest):
    ...
    def test_no_suburb(self):
        ...
        self.generate_fixtures(dsl.way(150939391, wkt_loads('POINT (-121.999127674959 37.5541029557231)'), {u'gnis:ST_alpha': u'CA', u'gnis:County_num': u'001', u'name': u'Centerville District', u'source': u'openstreetmap.org', u'gnis:ST_num': u'06', u'ele': u'16', u'import_uuid': u'bb7269ee-502a-5391-8056-e3ce0e66489c', u'gnis:Class': u'Populated Place', u'place': u'suburb', u'gnis:County': u'Alameda', u'gnis:id': u'1658251', u'is_in': u'Fremont,California,Calif.,CA,USA'}))
    ...
    def test_no_quarter(self):
        ...
        self.generate_fixtures(dsl.way(2790349074, wkt_loads('POINT (-76.98003089067129 38.91991558011007)'), {u'source': u'openstreetmap.org', u'place': u'quarter', u'name': u'Northeast'}))

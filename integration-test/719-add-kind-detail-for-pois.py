...
class AddKindDetailForPois(FixtureTest):
    def test_seafood_restaurant(self):
        self.generate_fixtures(dsl.way(1426311638, wkt_loads('POINT (-73.98758834870338 40.75562796002149)'), {u'cuisine': u'seafood', u'amenity': u'restaurant', u'name': u'Red Lobster', u'source': u'openstreetmap.org'}))
    ...
    def test_baseball_pitch(self):
        self.generate_fixtures(dsl.way(4305351592, wkt_loads('POINT (-73.7833481941897 40.84455331362909)'), {u'source': u'openstreetmap.org', u'sport': u'baseball', u'name': u'Anthony Ambrosini Field', u'leisure': u'pitch', u'surface': u'grass'}))

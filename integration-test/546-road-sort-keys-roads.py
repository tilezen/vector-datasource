...
class RoadSortKeysRoads(FixtureTest):
    ...
    def test_secondary(self):
        self.generate_fixtures(dsl.way(25337673, wkt_loads('LINESTRING (-122.419881845376 37.7703699989066, -122.419836570286 37.77048489185808, -122.419771622091 37.77063756144948)'), {u'tiger:name_base': u'Mission', u'lanes': u'2', u'name': u'Mission Street', u'tiger:cfcc': u'A41; A45', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'tiger:name_type': u'St', u'oneway': u'yes', u'highway': u'secondary', u'trolley_wire': u'yes'}))
    ...
    def test_parking_aisle(self):
        # service roads
        self.generate_fixtures(dsl.way(147002738, wkt_loads('LINESTRING (-122.478644600698 37.72751448527099, -122.478552972539 37.72752620859117, -122.47844724083 37.7275412712785, -122.478407535294 37.72754446854669, -122.478349863453 37.7275434027906, -122.477901693958 37.72752627964159)'), {u'source': u'openstreetmap.org', u'service': u'parking_aisle', u'highway': u'service'}))

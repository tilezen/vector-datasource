...
class RoadSortKeysRoads(FixtureTest):
    def test_motorway(self):
        # regular roads
        self.generate_fixtures(dsl.way(26765956, wkt_loads('LINESTRING (-122.47355250051 37.80545687798148, -122.473678623976 37.8055673159144, -122.473820108633 37.80569606532689, -122.47394632193 37.80581175507057, -122.474081428549 37.8059424203852, -122.474314182039 37.80619487846148)'), {
                               u'maxspeed': u'35 mph', u'hgv:state_network': u'yes', u'name': u'Presidio Parkway', u'note:lanes': u'center lanes are reversible, so number may be different', u'hgv': u'designated', u'source:hgv:state_network': u'Caltrans http://www.dot.ca.gov/hq/traffops/trucks/truckmap/', u'oneway': u'yes', u'lanes': u'5', u'lit': u'yes', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'alt_name': u'Doyle Drive', u'NHS': u'STRAHNET', u'toll': u'no', u'bicycle': u'no', u'ref': u'US 101;CA 1', u'highway': u'motorway'}))
    ...
    def test_trunk(self):
        self.generate_fixtures(dsl.way(65310628, wkt_loads('POINT (-122.475980826386 37.74678596946688)'), {u'source': u'openstreetmap.org', u'highway': u'traffic_signals'}), dsl.way(65316090, wkt_loads('POINT (-122.476110093955 37.74865039228589)'), {u'source': u'openstreetmap.org', u'highway': u'traffic_signals'}), dsl.way(89802409, wkt_loads('LINESTRING (-122.476110093955 37.74865039228589, -122.475980826386 37.74678596946688)'), {
                               u'tiger:name_base': u'19th', u'bicycle': u'yes', u'maxspeed': u'30 mph', u'hgv:state_network': u'yes', u'name': u'19th Avenue', u'tiger:cfcc': u'A35', u'tiger:name_base_1': u'State Highway 1', u'hgv': u'designated', u'source:hgv:state_network': u'Caltrans http://www.dot.ca.gov/hq/traffops/trucks/truckmap/', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'tiger:name_type': u'Ave', u'oneway': u'yes', u'foot': u'yes', u'lanes': u'3', u'sidewalk': u'right', u'ref': u'CA 1', u'highway': u'trunk'}))
    ...
    def test_primary(self):
        self.generate_fixtures(dsl.way(1728581633, wkt_loads('POINT (-122.387479523247 37.75027625452039)'), {u'source': u'openstreetmap.org', u'railway': u'level_crossing'}), dsl.way(4501286257, wkt_loads('POINT (-122.38748563179 37.75034898775849)'), {u'source': u'openstreetmap.org', u'railway': u'level_crossing'}), dsl.way(4501286260, wkt_loads('POINT (-122.38748149954 37.75029770515069)'), {u'source': u'openstreetmap.org', u'railway': u'level_crossing'}), dsl.way(
            160842753, wkt_loads('LINESTRING (-122.387479523247 37.75027625452039, -122.38748149954 37.75029770515069, -122.38748563179 37.75034898775849, -122.387531266207 37.7509209071746)'), {u'tiger:name_base': u'3rd', u'maxspeed': u'30 mph', u'lanes': u'2', u'name': u'3rd Street', u'tiger:cfcc': u'A45', u'surface': u'asphalt', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'tiger:name_type': u'St', u'oneway': u'yes', u'highway': u'primary'}))
    ...
    def test_secondary(self):
        self.generate_fixtures(dsl.way(25337673, wkt_loads('LINESTRING (-122.419881845376 37.7703699989066, -122.419836570286 37.77048489185808, -122.419771622091 37.77063756144948)'), {
                               u'tiger:name_base': u'Mission', u'lanes': u'2', u'name': u'Mission Street', u'tiger:cfcc': u'A41; A45', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'tiger:name_type': u'St', u'oneway': u'yes', u'highway': u'secondary', u'trolley_wire': u'yes'}))
    ...
    def test_tertiary(self):
        self.generate_fixtures(dsl.way(65322629, wkt_loads('POINT (-122.40181420973 37.80231791588138)'), {u'source': u'openstreetmap.org', u'highway': u'traffic_signals'}), dsl.way(65333972, wkt_loads('POINT (-122.401067530066 37.79858441788151)'), {u'source': u'openstreetmap.org', u'turn_restrictions': u'no', u'highway': u'traffic_signals'}), dsl.way(3645272798, wkt_loads('POINT (-122.401086484518 37.79867910806588)'), {u'crossing': u'traffic_signals', u'source': u'openstreetmap.org', u'highway': u'crossing'}), dsl.way(255330035, wkt_loads(
            'LINESTRING (-122.40181420973 37.80231791588138, -122.401629965265 37.80139227809359, -122.401535282834 37.80092366998429, -122.401443025854 37.80046322164698, -122.401257703411 37.79953521823388, -122.401086484518 37.79867910806588, -122.401067530066 37.79858441788151)'), {u'tiger:name_base': u'Battery', u'maxspeed': u'25 mph', u'lanes': u'2', u'name': u'Battery Street', u'tiger:cfcc': u'A41', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'tiger:name_type': u'St', u'oneway': u'yes', u'sidewalk': u'both', u'highway': u'tertiary'}))
    ...
    def test_residential(self):
        self.generate_fixtures(dsl.way(65325902, wkt_loads('POINT (-122.400231557862 37.71432265607909)'), {u'source': u'openstreetmap.org', u'highway': u'turning_circle'}), dsl.way(8919312, wkt_loads(
            'LINESTRING (-122.400231557862 37.71432265607909, -122.400242337646 37.7142653792107, -122.400258417489 37.71422721829488, -122.400291924649 37.71417939276188, -122.401426946011 37.71302595662628, -122.401543906661 37.7129330044265, -122.401691859188 37.71285597055789, -122.401931889032 37.7127569776553, -122.402171290055 37.7126810095736)'), {u'name': u'Racine Lane', u'tiger:reviewed': u'no', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'tiger:name_type': u'Ln', u'highway': u'residential'}))
    ...
    def test_service(self):
        self.generate_fixtures(dsl.way(59161514, wkt_loads('LINESTRING (-122.4472244965 37.80663996058681, -122.44711463254 37.8067056828995, -122.446758001373 37.80679809149498, -122.446403795656 37.80689000315549, -122.446004135186 37.80698539243338, -122.444982211719 37.80729270973048, -122.444909807507 37.80734345599718, -122.444832013403 37.80740499023472)'), {
                               u'name': u'Yacht Road', u'tiger:cfcc': u'A41', u'source': u'openstreetmap.org', u'tiger:county': u'San Francisco, CA', u'oneway': u'yes', u'highway': u'service'}))
    ...
    def test_parking_aisle(self):
        # service roads
        self.generate_fixtures(dsl.way(147002738, wkt_loads('LINESTRING (-122.478644600698 37.72751448527099, -122.478552972539 37.72752620859117, -122.47844724083 37.7275412712785, -122.478407535294 37.72754446854669, -122.478349863453 37.7275434027906, -122.477901693958 37.72752627964159)'), {
                               u'source': u'openstreetmap.org', u'service': u'parking_aisle', u'highway': u'service'}))

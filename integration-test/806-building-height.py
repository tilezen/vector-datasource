...
class BuildingHeight(FixtureTest):
    ...
    def test_min_height_from_min_levels(self):
        self.generate_fixtures(dsl.way(336433763, wkt_loads('POLYGON ((-75.1567581775674 39.9518723960957, -75.156733114571 39.95199318243088, -75.15669017510038 39.95220658946529, -75.15667077149018 39.95231009060419, -75.1564673929099 39.95228529992648, -75.15649012028659 39.95217801127889, -75.1565289275069 39.95200075739349, -75.15656144652019 39.9518483627573, -75.1567581775674 39.9518723960957))'), {
                               u'building:part': u'yes', u'source': u'openstreetmap.org', u'way_area': u'1444.36', u'building:min_levels': u'1'}))

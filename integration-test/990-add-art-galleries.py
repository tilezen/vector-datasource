...
class AddArtGalleries(FixtureTest):
    def test_node(self):
        self.generate_fixtures(dsl.way(2026996113, wkt_loads('POINT (-122.399331086621 37.78741651330239)'), {
                               u'addr:housenumber': u'111', u'source': u'openstreetmap.org', u'tourism': u'gallery', u'name': u'111 Minna', u'addr:street': u'Minna Street'}))
